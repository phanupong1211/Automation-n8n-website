...
"[project]/src/components/(marketing)/HeroSection.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const HERO_BACKGROUND = "https://www.npsplc.com/storage/our-business/our-business-banner.jpg";
function HeroSection() {
    ...
    const heroInitial = shouldReduceMotion ? false : {
        scale: 0.95,
        opacity: 0
    };
    ...
    const riseInitial = shouldReduceMotion ? false : {
        y: 20,
        opacity: 0
    };
...
"[project]/src/components/(marketing)/HeroSection.tsx [app-ssr] (ecmascript, next/dynamic entry)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.n(__turbopack_context__.i("[project]/src/components/(marketing)/HeroSection.tsx [app-ssr] (ecmascript)"));
}}),

};

//# sourceMappingURL=src_components_%28marketing%29_HeroSection_tsx_a1eee8c0._.js.map