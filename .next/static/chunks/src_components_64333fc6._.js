    ...
    const experiences = [
        {
            ...
            achievements: [
                "ออกแบบระบบรดน้ำต้นไม้ที่สามารถควบคุมผ่านรีเลย์โดยใช้โมดูล LoRaWAN LT2222L เชื่อมต่อกับ Gateway",
                "พัฒนา Dashboard หรือ Web Interface สำหรับควบคุมและตรวจสอบสถานะการรดน้ำแบบเรียลไทม์",
                "ติดตั้งและทดสอบระบบต้นแบบ (Demo) เพื่อควบคุมเปิด–ปิดน้ำจากระยะไกล พร้อมตรวจสอบความเสถียรของระบบ"
            ],
            technologies: [
                "LoRaWAN",
                "Signal 4-20mA",
        ...
        },
        {
            ...
            achievements: [
                "คัดเลือกเทคโนโลยีอุปกรณ์วัดอัตราการไหล ที่รองรับการสื่อสารผ่าน LoRaWAN",
                "เชื่อมต่อระบบกับ Gateway และ Platform แสดงผล เพื่อให้สามารถมอนิเตอร์ข้อมูลแบบเรียลไทม์",
...
"[project]/src/components/EducationSection.tsx [app-client] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, k: __turbopack_refresh__, m: module, e: exports } = __turbopack_context__;
{
const e = new Error(`Could not parse module '[project]/src/components/EducationSection.tsx'
...
//# sourceMappingURL=src_components_64333fc6._.js.map