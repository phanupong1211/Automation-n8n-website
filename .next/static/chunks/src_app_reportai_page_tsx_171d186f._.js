...
"[project]/src/app/reportai/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ReportAIPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReportAIPage.useEffect": ()=>{
            ...
            es.onmessage = ({
                "ReportAIPage.useEffect": (event)=>{
                    try {
                        const data = JSON.parse(event.data);
                        if (data.type === "response") {
                            setMessages({
                                "ReportAIPage.useEffect": (prev)=>{
                                    const filtered = prev.filter({
                                        "ReportAIPage.useEffect.filtered": (msg)=>!msg.isLoading
                                    }["ReportAIPage.useEffect.filtered"]);
                                    return [
                                        ...filtered,
                                        {
            ...
            es.onerror = ({
                "ReportAIPage.useEffect": ()=>es.close()
            })["ReportAIPage.useEffect"];
            return ({
                "ReportAIPage.useEffect": ()=>es.close()
            })["ReportAIPage.useEffect"];
...
_s(ReportAIPage, "dabcxzwzMx16ZFJtK+Kw6O+dl0I=");
_c = ReportAIPage;
var _c;
__turbopack_context__.k.register(_c, "ReportAIPage");
...
//# sourceMappingURL=src_app_reportai_page_tsx_171d186f._.js.map