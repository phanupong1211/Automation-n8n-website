...
export default function MaintHistorypH({ rows, kind, tag }: { rows: Record<string, any>[]; kind: string; tag: string }) {
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-6">
      <h3 className="mb-4 text-lg font-semibold text-slate-900">Maintenance History (pH Sensor)</h3>
